...
ymax = max(yvals)+ydiff/1.5
print ymin, ymax

g_down2.SetMinimum(ymin)
g_down2.SetMaximum(ymax)
g_down2.GetXaxis().SetLimits(xmin,xmax)

if args.variation == "MC": g_down2.GetXaxis().SetTitle('Combined MC systematic')
if args.variation == "ABCD": g_down2.GetXaxis().SetTitle('ABCD systematic')

g_down2.GetYaxis().SetTitle('95% CL Upper Limit on #sigma #times BR [pb]')
